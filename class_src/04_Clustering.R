...
##  Generated from R/04_Clustering.R by scripts/make_class_src.py --
##  edit R/04_Clustering.R and regenerate; changes made here will be overwritten.
## ============================================================================
...
but <- read.csv("ButterfliesQRoo2.csv", stringsAsFactors = TRUE)
...
if (interactive() && requireNamespace("rgl", quietly = TRUE)) {
  ...
  message("Skipped: rotatable 3-D view of the site clusters.  Install with: install.packages(c(\"rgl\"))")
}
...
if (requireNamespace("pvclust", quietly = TRUE)) {
  ...
  print(dcb)
} else message("Skipped: bootstrap support for the dendrogram.  Install with: install.packages(c(\"pvclust\"))")
## ============================================================================
...
if (requireNamespace("ape", quietly = TRUE)) {
  ...
  plot(apec, type = "cladogram", tip.col = mypal[clus4], cex = .6,
       main = "cladogram")
  par(op)
} else message("Skipped: fan and cladogram tree layouts.  Install with: install.packages(c(\"ape\"))")
