...
#   taxon = read.csv("taxon.csv", stringsAsFactors = TRUE),
...
taxon <- get_data("taxon")           # Crawley, "The R Book"
...
if (requireNamespace("vegan", quietly = TRUE)) {
  ...
  with_fig("12_betadisper_varespec", {
...
} else skip_note("rotatable 3-D view of the discriminant space", "rgl")
