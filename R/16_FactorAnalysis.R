## ============================================================================
##  MS_LJMR :: 16_FactorAnalysis.R — Exploratory Factor Analysis
##
...
cat("\n[16_FactorAnalysis] FA models shared variance via latent factors +",
